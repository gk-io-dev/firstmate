...
[`configuration.md`](configuration.md#runtime-backend-configbackend--fm_backend) owns home-scoped Treehouse pool configuration, while [`bin/fm-spawn.sh`](../bin/fm-spawn.sh)'s header owns the foreign-home claim refusal and same-home reuse boundary.
